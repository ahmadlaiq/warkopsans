    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  {{ Route::is('mejas.*') ? 'active' : '' }}">
                    <a href="{{ route('mejas.index') }}" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span>Meja</span>
                    </a>
                </li>

                <li class="sidebar-item {{ Route::is('menu-items.*') ? 'active' : '' }} ">
                    <a href="{{ route('menu-items.index') }}" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                ...
                <li class="sidebar-item  {{ Route::is('promotions.*') ? 'active' : '' }}">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('logout') }}" class='sidebar-link bg-danger text-white'
